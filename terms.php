...
<body>
      ...
      <h1 style="text-align: center; margin-bottom: 50px; font-family: tahoma; color: black" class="w3-text-black;"><b>Below are the various terms related to this project</b></h1>
	<div class="container-fluid">
		...
		<div class="col-sm-12">
			<div class="col-lg-4 ">
				<button onclick="document.getElementById('id04').style.display='block'" class="w3-btn w3-hover-white" style="height: 100px; width: 400px;">Conjucctivitis</button>
			</div>
			<div class="col-lg-4 ">
